...
function checkAnswer() {
    ...
    if (answerIsCorrect) {
        ...
        // let questionIsHard = (currentAnswer > 70 && (operand1.innerHTML.slice(0, -1) % 10) && (operand2.innerHTML.slice(0, -1) % 10));
        // if (questionIsHard) {
...
function showHowToPlay() {
    ...
    The questions are randomized and include numbers up to 10.<br>\
